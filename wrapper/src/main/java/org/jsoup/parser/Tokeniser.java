...
final class Tokeniser {
    ...
    Token read() {
        ...
        if (charsBuilder.length() > 0) {
            ...
            charsString = null;
            org.jsoup.parser.Token.Character data = charPending.data(str);
            data.setTokenIsndex(this.indexCounter++);
//            System.out.println("1:"+ data.getData() + "->" + this.indexCounter);
            return data ;
//            return charPending.data(str);
        } else if (charsString != null) {
            Token token = charPending.data(charsString);
            token.setTokenIsndex(this.indexCounter++);
//            System.out.println("2:"+ token.toString() + "->" + this.indexCounter);
            charsString = null;
            return token;
        } else {
            isEmitPending = false;
            
            emitPending.setTokenIsndex(this.indexCounter++);
//            System.out.println("3:"+ emitPending.toString() + "->" + this.indexCounter);
            return emitPending;
        }
    }
